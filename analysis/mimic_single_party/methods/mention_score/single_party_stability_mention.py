...
num_cands_to_keep = 4
METHOD = 'mention'
data_file = f'/Users/xiaokaren/MyPythonCode/ranked_choice_voting/rcv_proposal/analysis/mimic_single_party/methods/mention_score/scotland_results_top{num_cands_to_keep}.csv'
