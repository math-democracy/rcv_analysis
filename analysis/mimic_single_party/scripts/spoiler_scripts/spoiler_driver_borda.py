...
with open(f'./analysis/mimic_single_party/metadata/party_breakdown.json') as file:
...
def run_voting_methods(full_path):
    ...
    if condensed_cands:
        ...
        data['borda-om'] = list(mm.Borda_OM(v_profile, tiebreak="first_place", cands_to_keep=candidates))
        data['borda-avg'] = list(mm.Borda_AVG(v_profile, tiebreak="first_place", cands_to_keep=candidates))
