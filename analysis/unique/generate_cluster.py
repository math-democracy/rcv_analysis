...
with open('analysis2.json', 'r') as f:
    data = json.load(f)
...
# sns.heatmap(similarity_matrix, xticklabels=all_methods, yticklabels=all_methods, cmap='coolwarm', annot=True)
# plt.title("Cosine Similarity Between Voting Methods")
# plt.show()
