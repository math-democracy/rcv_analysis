...
data_file = f'analysis/stability/america_results_top{num_cands_to_keep}.csv'
root_dir = 'raw_data/america/processed_data'

error_file = 'analysis/stability/results/supporting_files/america_error.txt'
processed_file = 'analysis/stability/results/supporting_files/america_processed.txt'
all_data = []
