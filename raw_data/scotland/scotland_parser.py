...
def normalize_parties(party):
    replacements = [
        ...
        (r'Scotland Ind Network|Independent \(Ind\)|Independents|Independent|\bInd\b|\bind\b', '(Ind)'),
        ...
        (r'UK Independence Party \(UKIP\)|UK Independence Party|UK Independence|UKIP', '(UKIP)'),
        ...
        (r'Britannica Party|Britannica', '(Britannica)'),
        (r'\bPir\b|Pirate', '(Pir)'),
        (r'Communist Party of Britain|\bComm\b|Communist', '(Comm)'),
